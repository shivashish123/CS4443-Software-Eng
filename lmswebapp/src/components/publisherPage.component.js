    ...
    return (
      <Card style={{ width: "18rem" }} key={index} className="box">
        ...
        <Card.Body>
          ...
          <Button variant="secondary" type="submit" size="large">
            Select Book
          </Button>
        </Card.Body>
      </Card>
...
export default class PublisherPage extends Component {
  constructor(props) {
    ...
    this.state = {
      publicationName: "Rolling publication",
      bookList: [],
    };
  }
      ...
      <div>
        <div className="col-md-16">
          <div className="card card-container">
            {/* <img src={logo} alt="Author-img" className="author-img-card" /> */}
            <h5>Publisher books</h5>
          </div>
        </div>
